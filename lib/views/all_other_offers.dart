...
class AllOthersOffers extends GetView<AuthController> {
  final format = DateFormat.jm();

  @override
  Widget build(BuildContext context) {

    controller.getOffersCount(user_id: Get.arguments);
    ...
    return Obx(() => Scaffold(
        ...
        body: controller.allOffers.value.isEmpty ? Center(child: Text("لا يوجد عروض",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),) : Padding(
          ...
          child: ListView.separated(
              ...
              itemCount: controller.allOffers.value.length,
              itemBuilder: ((BuildContext context, int index) {
                DateTime dateTime = DateTime.parse(controller.allOffers.value[index]['created_at']);
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image:
                                      controller.allOffers.value[index]['user']['image']== null || controller.allOffers.value[index]['user']['image'] == "user.png" ?
                                      NetworkImage("https://www.pngjoy.com/pngm/136/2750635_gray-circle-login-user-icon-png-transparent-png.png") :
                                      NetworkImage("${controller.allOffers.value[index]['user']['image'].toString()}"),
                                    )
                                ),
                              ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: CustomText(
                                            userName: true,
                                            text: controller.allOffers.value[index]['user']['full_name'].toString(),
                                            textColor: nameColor,
                                            textSize: 18.0,
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 2,
                                child: CustomText(
                                  text: controller.allOffers.value[index]['id'].toString(),
                                  textColor: nameColor,
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 2,
                                child: CustomText(
                                  text: controller.allOffers.value[index]['type'].toString() == "sale" ? "مطلوب للبيع " : "مطلوب للشراء",
                                  textColor: nameColor,
                                  textFontWeight: FontWeight.w500,
                                  textSize: 14.0,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 2,
                                child: CustomText(
                                  text: controller.allOffers.value[index]['currency_type'].toString() ,
                                  textColor: nameColor,
                                  textFontWeight: FontWeight.w500,
                                  textSize: 14.0,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 2,
                                child: CustomText(
                                  text: controller.allOffers.value[index]['payment_type'].toString() ,
                                  textColor: nameColor,
                                  textFontWeight: FontWeight.w500,
                                  textSize: 14.0,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 2,
                                child: CustomText(
                                  text: "علي المشتري (${controller.allOffers.value[index]['percent'].toString()})",
                                  textColor: nameColor,
                                  textFontWeight: FontWeight.w500,
                                  textSize: 14.0,
                                ),
