...
class AllUserOrders extends GetView<ProfileController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => Scaffold(
        ...
        body: controller.allOrders.value.isEmpty ? Center(child: Text("لا يوجد صفقات",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),) : Padding(
