...
class AllOtherOrders extends GetView<AuthController> {
  final format = DateFormat.jm();

  @override
  Widget build(BuildContext context) {

    controller.getOrdersCount(user_id: Get.arguments);
    ...
    return Obx(() => Scaffold(
        ...
        body: controller.allOrders.value.isEmpty ? Center(child: Text("لا يوجد صفقات",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),) :
        ...
        Padding(
          ...
          child: ListView.separated(
              ...
              itemBuilder: ((BuildContext context, int index) {
                DateTime dateTime = DateTime.parse(controller.allOrders.value[index]['created_at']);
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image:
                                      controller.allOrders.value[index]['user']['image']== null || controller.allOrders.value[index]['user']['image'] == "user.png" ?
                                      NetworkImage("https://www.pngjoy.com/pngm/136/2750635_gray-circle-login-user-icon-png-transparent-png.png") :
                                      NetworkImage("${controller.allOrders.value[index]['user']['image'].toString()}"),
                                    )
                                ),
                              ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: CustomText(
                                            userName: true,
                                            text: controller.allOrders.value[index]['user']['full_name'].toString(),
                                            textColor: nameColor,
                                            textSize: 18.0,
